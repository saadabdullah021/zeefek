...
<body class="template-page-contact-style-1">
				...
				<nav>
					...
					<div class="template-component-menu-default">
						<ul class="sf-menu">
							...
							<li>
								<a href="contact.php" class="template-state-selected">Contact</a>
	...
	<div class="template-content">
			...
			<div class="template-component-feature-list template-component-feature-list-position-left template-clear-fix">
				...
				<ul class="template-layout-33x33x33 template-clear-fix">
					...
					<li class="template-layout-column-center">
						...
						<h5>Our Address</h5>
						<p>
							556 F Eden Valley <br />
							Canal Road <b>FAISALABAD </b>
						</p>
					</li>
		...
		<div class="template-section template-padding-reset template-main template-clear-fix">
			...
			<!-- Contact form -->
			<form name="contact-form" id="contact-form" method="POST" action="contactconfig.php" class="template-component-contact-form">
				...
				<ul class="template-layout-50x50 template-layout-margin-reset template-clear-fix">
					...
					<li class="template-layout-column-left template-margin-bottom-reset">
						<div class="template-component-form-field template-state-block">
							...
							<input type="text" name="contact-form-name" required="true" id="contact-form-name" />
						</div>
						<div class="template-component-form-field template-state-block">
							<label for="contact-form-email">Your E-mail *</label>
							<input type="text" name="contact-form-email" required="true" id="contact-form-email" />
						</div>
						<div class="template-component-form-field template-state-block">
							<label for="contact-form-phone">Phone Number</label>
							<input type="text" name="contact-form-phone" required="true" id="contact-form-phone" />
						</div>
					</li>
					...
					<li class="template-layout-column-right template-margin-bottom-reset">
						<div class="template-component-form-field template-state-block">
							...
							<textarea rows="1" cols="1" name="contact-form-message" required="true" id="contact-form-message"></textarea>
						</div>
					</li>
				...
				<div class="template-layout-25x25x25x25 template-clear-fix">
					...
					<div class="template-layout-column-center-right">
						...
						<ul class="template-list-reset">
							...
							<li><a href="book-your-wash.php">Book Your Appoinment</a></li>
