...
<body class="template-page-service-style-2">
				...
				<nav>
					...
					<div class="template-component-menu-default">
						<ul class="sf-menu">
							...
							<li>
								<a href="service.php" class="template-state-selected">Services</a>
					...
					<ul>
						...
						<li data-index="slide-1" data-transition="fade" data-slotamount="1" data-easein="default" data-easeout="default" data-masterspeed="500" data-rotate="0" data-delay="6000">
							...
							<div class="tp-caption tp-resizeme" data-x="['center','center','center','center','center']" data-hoffset="['0','0','0','0','0']" data-y="['middle','middle','middle','middle','middle']" data-voffset="['150','137','121','142','165']" data-fontsize="['15','15','15','15','15']" data-fontweight="['400','400','400','400','400']" data-lineheight="['15','15','15','15','15']" data-whitespace="['nowrap','nowrap','nowrap','nowrap','nowrap']" data-width="['auto','auto','auto','auto','auto']" data-height="auto" data-basealign="grid" data-transform_idle="o:1;" data-transform_in="o:1;x:0px;y:[-100%];z:0px;s:1500;e:Power4.easeInOut;" data-transform_out="o:1;x:0px;y:[100%];z:0px;s:750;e:Power4.easeInOut;" data-mask_in="x:0px;y:0px;s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="2500" data-splitin="none" data-splitout="none" data-responsive_offset="on">
								...
								<a class="template-component-button template-color-white" href="book-your-wash.php" title="Purchase Template">BOOK YOUR APPOINMET</a>
							</div>
						</li>
	...
	<div class="template-content">
		...
		<div class="template-section template-section-padding-1 template-clear-fix template-main">
			...
			<div class="template-clear-fix template-align-center">
				...
				<p>
					...
					Our goal is to provide our customers with the friendliest, most convenient hand car wash & repairing experience possible.
				</p>
				...
				<!-- Button -->
				<a href="book-your-wash.php" class="template-component-button template-align-center">Book Appointemnt</a>
			...
			<div class="template-layout-33x33x33 template-clear-fix">
						...
						<ul class="template-layout-100 template-clear-fix">
							<li class="template-layout-column-left">
								...
								<p>
									...
									their community or its institutions.
									Community service is distinct from volunteering, since it is not always performed on a voluntary basis.</p>
							</li>
							<li class="template-layout-column-left">
								<span class="">
									<i class="fas fa-car-crash" style="font-size: 35px; color:#0096FF; opacity:1;"></i>
									<!-- 	<img src="media/image/car_dent.png" width="50px" alt=""> -->
								</span>
								<h5>Denting & Painting</h5>
								<p>
									If you are having a problem with your vehicle and if you are not getting time for visiting workshop
									for your car so please book an appointment.
									Zeefek provides best denting painting services that keep your vehicle looking its best.</p>
							</li>
							<li class="template-layout-column-left template-margin-bottom-reset">
								<span class="template-icon-feature-coffee"></span>
								<h5> Vehicle Wash</h5>
								<p>
									If you are not getting time for visiting the workshop for your car’s wash so please
									book an appointment.
									Zeefek provides car wash services at most affordable prices in Faisalabad. </p>
							</li>
						</ul>
					</div>
				...
				<div class="template-layout-column-center">
					<div class="template-component-image template-component-image-preloader">
						<img src="media/image/bg.jpg" alt="Image Not found" />
					</div>
				</div>
					...
					<div class="template-component-feature-list template-component-feature-list-position-left">
						<ul class="template-layout-100 template-clear-fix">
							<li class="template-layout-column-left">
								...
								<p>
									If you are not getting time for visiting the workshop for your car’s maintenance so please
									book an appointment. Zeefek provides car mechanic, electrical and denting & painting services at
									most affordable prices in Faisalabad. Workers of garages will service vehicle
									at customers home or will collect the vehicle, will service the vehicle at garage and they will be
									return.</p>
							</li>
							<li class="template-layout-column-left">
								<span class="template-icon-feature-phone-call"></span>
								<h5>Electrcal Services</h5>
								<p>
									If you are having a problem with your vehicle and can’t work out how to fix it, it may be time to take
									it in to an automotive electrician workshop. So please book an appointment.
									Zeefek offer best car electrical services with our experienced car electrician.</p>
							</li>
							<li class="template-layout-column-left template-margin-bottom-reset">
								<span class="template-icon-feature-shopping-cart"></span>
								<h5>Mechnical Services</h5>
								<p>
									Technical and mechanical working is always high in demand because we are living in an era of technology,
									ransportation. Everything cannot be done by yourself, it is not possible when it comes to fixing your car
									at your home, there is a need of a mechanic. So please book an appointment.
									Zeefek provides car mechanic services at most affordable prices in Faisalabad. </p>
							</li>
						</ul>
		...
		<!-- Section -->
		<div style="background-image: url('media/image/car1.jpg');" class="template-section template-background-image template-background-image-6 template-background-image-parallax template-color-white template-clear-fix">
			...
			<div class="template-main">
				...
				<div class="template-component-testimonial-list template-clear-fix">
					...
					<ul class="template-clear-fix">
						<li>
							<p>I just got a deluxe wash package and interior shampoo and was blown away by the quality and detail of the service. I couldn&#039;t be happier and have recommend friends and family members to stop by for the best car wash &amp; Other Garage Services in Faisalabad.</p>
							<h6>Rameesha Sajid </h6>
							<span>Audi Q5</span>
						</li>
						<li>
			...
			<div class="template-component-counter-box-list">
				...
				<ul class="template-layout-25x25x25x25 template-layout-margin-reset template-clear-fix">
					...
					<li class="template-layout-column-right template-background-color-2">
						<span class="template-value">12</span>
						<span class="template-icon-feature-coffee"></span>
						<h6>Bookings</h6>
					</li>
