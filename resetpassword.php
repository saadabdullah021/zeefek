        ...
        <div class="card-wrapper">
          ...
          <div class="card fat">
            <div class="card-body">
              ...
              <form method="POST" class="my-login-validation" novalidate="" action="resetpasswordconfig.php">
                ...
                <div class="form-group m-0">
                  <input type="submit" class="btn btn-primary btn-block" value=" Reset Password" name="resetpassword" />
                ...
                <br>
                <div class="form-group m-0">
                  <input type="button" onclick="backtoreset()" class="btn btn-primary btn-block" value="Back to Reset Password" />
